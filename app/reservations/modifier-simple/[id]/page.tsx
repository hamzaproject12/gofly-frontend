...
export { default } from "../../modifier/[id]/page"
"use client"
...
export default function EditReservation() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // V├⌐rifier si un nouveau passeport est upload├⌐ OU si un passeport existe d├⌐j├á
      ...
      if (documents.passport && reservationId) {
        console.log('≡ƒôñ Upload passeport vers Cloudinary...')
        ...
        if (!passportResponse.ok) {
          ...
          console.log('Γ£à Passeport upload├⌐ avec succ├¿s')
        }
      }
  ...
  const getDocumentUrl = (type: string) => {
    ...
    if (existingDoc) {
      console.log('≡ƒöì Debug - Found document for type:', {
        requestedType: type,
                  ...
                  <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-3 py-1.5 rounded-lg border border-white/30">
                        ...
                        <span className="text-sm text-white/80 font-medium">Reste ├á payer</span>
                        <span className="text-lg font-bold text-white">
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    {!getDocumentUrl('passport') ? (
                      ...
                      <div className="mt-2 p-2 border border-blue-200 rounded-lg bg-white">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm font-medium text-blue-700">Aper├ºu du passeport</span>
                          <div className="flex items-center gap-2">
                            <button
                              type="button"
              ...
              <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-xl border border-blue-200 mb-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {/* Upload de re├ºu de paiement */}
                      {!paiement.recu && (
                        <div className="mt-3 space-y-2">
                          <Label className="text-blue-700 font-medium text-sm">Re├ºu de paiement</Label>
                          <div className="flex items-center gap-2">
                            <Input
                              type="file"
                      ...
                      {previews[`payment_${index}`] && (
                        <div className="mt-3 p-2 border border-blue-200 rounded-lg bg-white">
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-sm font-medium text-blue-700">Aper├ºu du nouveau re├ºu</span>
                            <div className="flex items-center gap-2">
                              <button
                                type="button"
                      ...
                      {paiement.id && paiement.recu && (
                        <div className="mt-3 p-2 border border-blue-200 rounded-lg bg-white">
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-sm font-medium text-blue-700">Re├ºu de paiement</span>
                            <div className="flex items-center gap-2">
                              <button
                                type="button"
                                className="text-blue-600 hover:text-blue-800 hover:bg-blue-50 p-1 rounded"
                                onClick={() => setPreviewImage({ url: paiement.recu || '', title: 'Re├ºu paiement', type: 'image/*' })}
                              >
                                <ZoomIn className="h-4 w-4" />
                              </button>
                            </div>
